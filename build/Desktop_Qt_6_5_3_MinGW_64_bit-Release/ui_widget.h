...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        gridLayout->addWidget(num_2, 8, 1, 1, 1);
        ...
        gridLayout->addWidget(symEqual, 9, 3, 1, 1);
        ...
        gridLayout->addWidget(num_0, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(num_9, 6, 2, 1, 1);
        ...
        gridLayout->addWidget(num_5, 7, 1, 1, 1);
        ...
        gridLayout->addWidget(symMul, 6, 3, 1, 1);
        ...
        gridLayout->addWidget(symClear, 9, 0, 1, 1);
        ...
        gridLayout->addWidget(num_8, 6, 1, 1, 1);
        ...
        gridLayout->addWidget(num_1, 8, 0, 1, 1);
        ...
        gridLayout->addWidget(symMinus, 7, 3, 1, 1);

        symDot = new QPushButton(groupBox);
        symDot->setObjectName("symDot");
        sizePolicy2.setHeightForWidth(symDot->sizePolicy().hasHeightForWidth());
        symDot->setSizePolicy(sizePolicy2);

        gridLayout->addWidget(symDot, 9, 2, 1, 1);
        ...
        gridLayout->addWidget(num_3, 8, 2, 1, 1);
        ...
        gridLayout->addWidget(num_4, 7, 0, 1, 1);
        ...
        gridLayout->addWidget(num_7, 6, 0, 1, 1);
        ...
        gridLayout->addWidget(symPlus, 8, 3, 1, 1);
        ...
        gridLayout->addWidget(num_6, 7, 2, 1, 1);

        symDiv = new QPushButton(groupBox);
        symDiv->setObjectName("symDiv");
        sizePolicy2.setHeightForWidth(symDiv->sizePolicy().hasHeightForWidth());
        symDiv->setSizePolicy(sizePolicy2);

        gridLayout->addWidget(symDiv, 4, 2, 1, 1);
        ...
        gridLayout->addWidget(symDel, 4, 3, 1, 1);

        num_10 = new QPushButton(groupBox);
        num_10->setObjectName("num_10");
        sizePolicy2.setHeightForWidth(num_10->sizePolicy().hasHeightForWidth());
        num_10->setSizePolicy(sizePolicy2);

        gridLayout->addWidget(num_10, 4, 1, 1, 1);

        num_12 = new QPushButton(groupBox);
        num_12->setObjectName("num_12");
        num_12->setEnabled(true);
        sizePolicy2.setHeightForWidth(num_12->sizePolicy().hasHeightForWidth());
        num_12->setSizePolicy(sizePolicy2);
        num_12->setMinimumSize(QSize(0, 0));
        num_12->setBaseSize(QSize(0, 0));

        gridLayout->addWidget(num_12, 4, 0, 1, 1);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        symDot->setText(QCoreApplication::translate("Widget", ".", nullptr));
        ...
        symDiv->setText(QCoreApplication::translate("Widget", "/", nullptr));
        symDel->setText(QCoreApplication::translate("Widget", "D", nullptr));
        num_10->setText(QCoreApplication::translate("Widget", "^2", nullptr));
        num_12->setText(QCoreApplication::translate("Widget", "?", nullptr));
